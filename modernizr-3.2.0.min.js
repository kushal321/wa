...
! function(e, n, t) {
    ...
    function p(e, t, o, r) {
        var s, i, l, f, u = "modernizr",
            ...
            p = d();
        if (parseInt(o, 10))
            for (; o--;) l = a("div"), l.id = r ? r[o] : u + (o + 1), c.appendChild(l);
    ...
    function h(e, n, r, s) {
        ...
        for (var c, d, p, h, v, y = ["modernizr", "tspan"]; !P.style;) c = !0, P.modElem = a(y.shift()), P.style = P.modElem.style;
        for (p = e.length, d = 0; p > d; d++)
            if (h = e[d], v = P.style[h], i(h, "-") && (h = l(h)), P.style[h] !== t) {
                if (s || o(r, "undefined")) return f(), "pfx" == n ? h : !0;
                try {
                    P.style[h] = r
                } catch (g) {}
    ...
    function v(e, n, t, r, s) {
        ...
        return o(n, "string") || o(n, "undefined") ? h(a, n, r, s) : (a = (e + " " + z.join(i + " ") + i).split(" "), u(a, n, t))
    }
    ...
    Modernizr._q.unshift(function() {
        delete P.style
    }), w.testAllProps = v, w.testAllProps = y, Modernizr.addTest("preserve3d", y("transformStyle", "preserve-3d"));
    var E = w._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : [];
    w._prefixes = E;
    var j = w.testStyles = p;
    Modernizr.addTest("touchevents", function() {
        var t;
        if ("ontouchstart" in e || e.DocumentTouch && n instanceof DocumentTouch) t = !0;
        else {
            var o = ["@media (", E.join("touch-enabled),("), "heartz", ")", "{#modernizr{top:9px;position:absolute}}"].join("");
            j(o, function(e) {
                t = 9 === e.offsetTop
            })
        }
        return t
    }), r(), s(g), delete w.addTest, delete w.addAsyncTest;
